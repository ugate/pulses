...
var sprops = [{ n: 'type', d: 'async', i: true, r: ['async', 'sync', 'fork', 'spawn', 'exec'] }, { n: 'repeat', d: 1, l: 1 }, { n: 'count', d: 0 }, { n: 'id' }];
 ...
 */
function Pulse(drip) {
    plet.props(this, sprops, drip.pulse, true);
...
function emit(pw, iv, drip) {
    ...
    var pulse = new Pulse(drip), m = drip.pulse.async ? pw.emitAsync : pw.emit;
 ...
 * @arg {String} t the type used when the passed object has no defined type or is invalid
 * @returns {Object} the passed object
 */
function typed(o, t) {
    o.type = o.type ? o.type.toLowerCase() : t ? t.toLowerCase() : 'async';
    if (o.type !== 'sync' && o.type !== 'fork' && o.type !== 'spawn' && o.type !== 'exec') {
        o.type = 'async';
    }
    o.async = o.type !== 'async';
    return o;
}
