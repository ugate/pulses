 ...
 * @arg {Object} [it] an object that defines how external events interact with event chain continuity
 ...
 */
function catheter(pw, lfn, it, pass, args) {
    var iv = [];
    iv.listen = lfn;
    iv.target = it || pw;
    iv.dripCount = 0;
 ...
 * @arg {PulseEmitter} pw the pulse emitter
 * @arg {Array} iv the I.V. catheter
 * @arg {Boolean} [noInbound] true to prevent inbound
